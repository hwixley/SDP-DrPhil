...
def intersect(ray1 : Ray, ray2 : Ray):
    ...
    segment1 = LineString([tuple(ray1.origin),tuple(ray1.dir * ray1.length + ray1.origin)])
    segment2 = LineString([tuple(ray2.origin),tuple(ray2.dir * ray2.length + ray2.origin)])
